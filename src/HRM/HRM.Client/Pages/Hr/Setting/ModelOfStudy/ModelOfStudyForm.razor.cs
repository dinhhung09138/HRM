...
{
    partial class ModelOfStudyForm : ComponentBase
    {
        [Inject]
        ...
        private Form<ModelOfStudyModel> form;
        private ModelOfStudyModel model = new ModelOfStudyModel();
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (Id.HasValue)
            {
                ...
                var result = await httpClientService.Get<ModelOfStudyModel, HttpDataResponseWrapper<ModelOfStudyModel>>($"hr/model-of-study/{Id.Value}");
        ...
        {
            navigationManager.NavigateTo("hr/setting/model-of-study");
        }
        ...
        protected async Task OnFinish(EditContext editContext)
        {
            ...
            if (Id.HasValue)
            {
                var response = await httpClientService.Put<ModelOfStudyModel, HttpActionResponseWrapper>($"hr/model-of-study/{Id.Value}", model);
            ...
            {
                var response = await httpClientService.Post<ModelOfStudyModel, HttpActionResponseWrapper>("hr/model-of-study", model);
                if (response.Succeeded)
                {
        ...
        private void DefineBreadcumb()
        {
            ...
            Breadcrumb.Add(new BreadcurmbModel()
            {
                ...
                Href = "hr/setting/model-of-study",
                IsActive = false,
            });
