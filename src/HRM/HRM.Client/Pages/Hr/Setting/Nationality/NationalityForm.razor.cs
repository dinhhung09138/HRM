...
{
    partial class NationalityForm : ComponentBase
    {
        [Inject]
        ...
        private Form<NationalityModel> form;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (Id.HasValue)
            {
                ...
                var result = await httpClientService.Get<NationalityModel, HttpDataResponseWrapper<NationalityModel>>($"hr/nationality/{Id.Value}");
        ...
        {
            navigationManager.NavigateTo("hr/setting/nationality");
        }
        ...
        protected async Task OnFinish(EditContext editContext)
        {
            ...
            if (Id.HasValue)
            {
                var response = await httpClientService.Put<NationalityModel, HttpActionResponseWrapper>($"hr/nationality/{Id.Value}", model);
            ...
            {
                var response = await httpClientService.Post<NationalityModel, HttpActionResponseWrapper>("hr/nationality", model);
                if (response.Succeeded)
                {
