...
{
    partial class PositionForm : ComponentBase
    {
        [Inject]
        ...
        private Form<PositionModel> form;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            if (Id.HasValue)
            {
                ...
                var result = await httpClientService.Get<PositionModel, HttpDataResponseWrapper<PositionModel>>($"hr/position/{Id.Value}");
        ...
        {
            navigationManager.NavigateTo("hr/setting/position");
        }
        ...
        protected async Task OnFinish(EditContext editContext)
        {
            ...
            if (Id.HasValue)
            {
                var response = await httpClientService.Put<PositionModel, HttpActionResponseWrapper>($"hr/position/{Id.Value}", model);
            ...
            {
                var response = await httpClientService.Post<PositionModel, HttpActionResponseWrapper>("hr/position", model);
                if (response.Succeeded)
                {
