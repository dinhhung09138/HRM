...
namespace HRM.Client.Helpers
{
    public class SelectboxDataHelper
    {
        ...
        {
            var response = await _httpClientService.Get<HttpDataResponseWrapper<List<BaseSelectboxModel>>>($"hr/branch/dropdown");
            List<BaseSelectboxModel> listData = new List<BaseSelectboxModel>();
        ...
        {
            var response = await _httpClientService.Get<HttpDataResponseWrapper<List<BaseSelectboxModel>>>($"hr/department/dropdown");
            List<BaseSelectboxModel> listData = new List<BaseSelectboxModel>();
        ...
        {
            var response = await _httpClientService.Get<HttpDataResponseWrapper<List<BaseSelectboxModel>>>($"hr/position/dropdown");
            List<BaseSelectboxModel> listData = new List<BaseSelectboxModel>();
        ...
        {
            var response = await _httpClientService.Get<HttpDataResponseWrapper<List<BaseSelectboxModel>>>($"hr/job-position/dropdown");
            List<BaseSelectboxModel> listData = new List<BaseSelectboxModel>();
        ...
        {
            var response = await _httpClientService.Get<HttpDataResponseWrapper<List<BaseSelectboxModel>>>($"hr/employee-working-status/dropdown");
            List<BaseSelectboxModel> listData = new List<BaseSelectboxModel>();
        ...
        {
            var response = await _httpClientService.Get<HttpDataResponseWrapper<List<BaseSelectboxModel>>>($"hr/employee/dropdown");
            List<BaseSelectboxModel> listData = new List<BaseSelectboxModel>();
